...
var barril = preload("res://scenes/Timber/barril.tscn")
var barrilEsq = preload("res://scenes/Timber/barrilEsq.tscn")
var barrilDir = preload("res://scenes/Timber/barrilDir.tscn")
...
func verif():
	...
	var prim = barris.get_children()[0]
	if ((lado == felpudo.ESQ and prim.is_in_group("barrilEsq")) or 
	    (lado == felpudo.DIR and prim.is_in_group("barrilDir"))):
		return true
	else:
		return false
